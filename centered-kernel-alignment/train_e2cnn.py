...
class EquivariantMNIST4Conv2FC(nn.Module):
    def __init__(self) -> None:
        ...
        # conv1: 입력 -> 16 복사 (regular representation, 각 복사 4차원 → 총 64 채널)
        ...
        # conv2: 16 복사 유지 (총 64 채널), 후 첫 번째 pooling (28x28 → 14x14)
        ...
        # conv3: 16 복사에서 32 복사 (총 32×4=128 채널), spatial: 14x14
        ...
        # conv4: 32 복사 유지 (총 128 채널), 후 두 번째 pooling (14x14 → 7x7)
        ...
        # conv4 출력: 32 복사, 각 regular repr 4차원 → 총 32*4 = 128 채널, 하지만 그룹 풀링으로 채널이 32가 됨.
        # 공간 크기: 7x7, 따라서 fc_in_features = 32 * 7 * 7 = 1568.
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        x = self.gpool(x)  # 그룹 풀링 후, 채널 수가 128 -> 32, shape: [B, 32, 7, 7]
...
if __name__ == '__main__':
    ...
    torch.save(model.state_dict(), 'task_model_e2cnn.pth')
    print("Model weights saved to task_model_e2cnn.pth")
