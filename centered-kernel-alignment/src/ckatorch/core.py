...
def cka_batch(x: torch.Tensor, y: torch.Tensor) -> torch.Tensor:
    ...
    # print("hsic1_xy.sum():", hsic1_xy.sum().item())
    # print("hsic1_xx.sum():", hsic1_xx.sum().item())
    # print("hsic1_yy.sum():", hsic1_yy.sum().item())

    epsilon = 1e-10
    denom = (hsic1_xx.sum() * hsic1_yy.sum()).sqrt() + epsilon
